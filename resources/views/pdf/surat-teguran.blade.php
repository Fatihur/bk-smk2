...
<head>
    ...
    <style>
        body { font-family: 'Times New Roman', Times, serif; font-size: 12pt; line-height: 1.4; color: #000; margin: 0; padding: 25px 10px; }
        .header { border-collapse: collapse; width: 100%; margin-bottom: 5px; }
        .header .logo { width: 90px; height: auto; }
        .header .text-wrap { margin-left: -51px; }
...
<body>
    <table class="header">
        <tr>
            <td style="width:102px;vertical-align:middle;padding:0">
